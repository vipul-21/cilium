...
const (
	...
	outcomeErrorCode       string  = "429"
	outcomeSuccessCode     string  = "200"
)
...
func (l *APILimiter) requestFinished(r *limitedRequest, err error, code string) {
	if r.finished {
		return
	}
...
func (l *limitedRequest) Error(err error, code string) {
...
func (d dummyRequest) Error(err error, code string) {}
